...
class FinalJobsScreen extends StatefulWidget {
  const FinalJobsScreen({Key? key}) : super(key: key);

  @override
  State<FinalJobsScreen> createState() => _JobsScreenState();
}

class _JobsScreenState extends State<FinalJobsScreen> {
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("CF001",style: TextStyle(color: AppColors.containerclr),),
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Booking Date",style: TextStyle(color: AppColors.AppbtnColor),),
                      Text("03/5/2023",style: TextStyle(color: AppColors.whit),),
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Functions ",style: TextStyle(color: AppColors.temtextclr),),
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Order Date ",style: TextStyle(color: AppColors.temtextclr),),
                      Text("10 /5/2023",style: TextStyle(color: AppColors.whit),),
                    ],
                  ),
                ),
                Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text("Order Jobs From  ",style: TextStyle(color: AppColors.AppbtnColor,fontSize: 15),),
                  Text("Kinjal Patel",style: TextStyle(color: AppColors.textclr,fontSize: 18),),
                ],
              ),
              SizedBox(height: 15,),
              Row(
