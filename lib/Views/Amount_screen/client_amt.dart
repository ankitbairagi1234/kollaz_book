...
import 'package:kolazz_book/Views/freelencing_jobpost/photographer_name_account.dart';
...
class ClientDetails extends StatefulWidget {
  ...
  @override
  State<ClientDetails> createState() => _JobsScreenState();
}

class _JobsScreenState extends State<ClientDetails> {
      ...
      bottomSheet: Padding(
        ...
        child: Row(
          ...
          children: [
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => ClientAccount()));
              },
              child: Container(
                height: 40,
                width: 160,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(40), color:AppColors.greenbtn
                ),
                child: Center(
